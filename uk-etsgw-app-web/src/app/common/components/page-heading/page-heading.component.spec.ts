...
describe('PageHeadingComponent', () => {
  ...
  @Component({
    template:
      '<etsgw-page-heading [caption]="caption" [size]="size">Test heading</etsgw-page-heading>',
    standalone: true,
  ...
  beforeEach(() => {
    ...
    component = fixture.debugElement.query(
      By.directive(PageHeadingComponent)
    ).componentInstance;
  ...
  it('should display heading', () => {
    expect(element.querySelector('h1.govuk-heading-l').textContent).toEqual(
      'Test heading'
    );
  });
  ...
  it('should display caption, if provided', () => {
    ...
    expect(element.querySelector('span.govuk-caption-l').textContent).toEqual(
      'Test caption'
    );
  });
